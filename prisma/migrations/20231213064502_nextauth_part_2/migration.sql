...
INSERT INTO "new_Issue" ("createdAt", "description", "id", "label", "priority", "projectId", "status", "title", "updatedAt", "userId") SELECT "createdAt", "description", "id", "label", "priority", "projectId", "status", "title", "updatedAt", "userId" FROM "Issue";
DROP TABLE "Issue";
