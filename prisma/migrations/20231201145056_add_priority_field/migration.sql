/*
  ...
  - Added the required column `priority` to the `Bug` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Bug" ("createdAt", "id", "projectId", "status", "title", "updatedAt", "userId") SELECT "createdAt", "id", "projectId", "status", "title", "updatedAt", "userId" FROM "Bug";
DROP TABLE "Bug";
