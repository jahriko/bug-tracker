...
export default async function ChooseCategoryPage({ params }: { params: { workspaceId: string } }) {
    ...
    <main className="flex flex-1 flex-col pb-2 lg:px-2">
      <div className="grow p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mb-6 text-zinc-600 dark:text-zinc-400">Select a category for your new discussion</p>
          <CategorySelector categories={categories} workspaceId={params.workspaceId} />
        </div>
      </div>
    </main>
  )
