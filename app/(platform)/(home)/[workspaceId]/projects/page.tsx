    ...
    <dd className="flex items-start gap-x-2">
      <div className="flex -space-x-1 overflow-hidden">
        {visibleAvatars.map((avatar, index) => (
          <Avatar className="size-7 ring-2 ring-white dark:ring-zinc-900" src={avatar.user.image} />
        ))}

        {remainingCount > 0 && (
          <Avatar className="size-7 bg-zinc-50 text-2xs ring-2 ring-white dark:ring-zinc-900" initials="+4" />
        )}
      </div>
    </dd>
  )
