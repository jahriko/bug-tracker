  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold leading-7 text-gray-900">Workspace Members</h2>
          <p className="mt-1 text-sm leading-6 text-gray-500">Manage members of your workspace.</p>
        </div>
        <Button>
          <UserPlusIcon />
          Invite people
      ...
      <ul className="mt-6 divide-y divide-gray-100" role="list">
        {sortedMembers.map((member) => (
          <li className="flex items-center gap-x-4 py-5" key={member.user.email}>
            <img
              alt=""
