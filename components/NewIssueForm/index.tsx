...
import { StatusBox } from "@/components/issue/StatusBox"
import { PriorityBox } from "@/components/issue/PriorityBox"
import { LabelBox } from "@/components/issue/LabelBox"
    ...
    <div className="mx-auto max-w-[1300px] py-8 xl:py-10">
      <Form {...form}>
        ...
        >
          ...
          <aside className="xl:col-span-1 xl:pl-8">
